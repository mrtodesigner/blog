thanh1=jQuery.noConflict();
thanh1.easing['jswing'] = thanh1.easing['swing'];

thanh1.extend( thanh1.easing,
{
	def: 'easeOutQuad',
	swing: function (x, t, b, c, d) {
		
		return thanh1.easing[thanh1.easing.def](x, t, b, c, d);
	},
	...
	easeInBounce: function (x, t, b, c, d) {
		return c - thanh1.easing.easeOutBounce (x, d-t, 0, c, d) + b;
	},
	...
	easeInOutBounce: function (x, t, b, c, d) {
		if (t < d/2) return thanh1.easing.easeInBounce (x, t*2, 0, c, d) * .5 + b;
		return thanh1.easing.easeOutBounce (x, t*2-d, 0, c, d) * .5 + c*.5 + b;
	}
});
...
;(function($) {
	...
	var defaults = {
		...
		structure: 	 			  '<a href="#" class="prev_button" style="">prev</a>'
								+ '<a href="#" class="next_button" style="">next</a>'
	...
	$sk.fn.extend({
		...
		getEasing: function(easing)
		{
			...
			if (thanh1.inArray(easing, easing_accepts) > 0) {
				return easing;
			}
			else {
				return '';
	...
	$.fn.css = function (arg, val) {
		...
		if (_propsObj['transform'] != 'transform') {
			...
			if (arg == 'transform') {
				...
				if (typeof val == 'undefined' && thanh1.style) {
					return thanh1.style(this.get(0), arg);
				}
			}
